...
const sphere = new THREE.Mesh(new THREE.SphereBufferGeometry(.5, 8, 8), new THREE.MeshBasicMaterial({
    color: 0x00ff66,
    wireframe: true
}));
...
const pyramid = new THREE.Mesh(new THREE.ConeBufferGeometry(.66, 1, 4), new THREE.MeshBasicMaterial({
    color: 0xffff00,
    wireframe: true
}));
